Pod::Spec.new do |s|
  ...
  s.description      = "DESC
                       ...
                       DESC"
  s.homepage         = "https://github.com/LuminSoft/eNROLL-neo-core-specs" 
  ...
  s.source           = { :git => 'https://github.com/LuminSoft/eNROLL-neo-core-specs', :tag => s.version.to_s }
